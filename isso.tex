...
\begin{itemize}
\item Participación en proyectos de investigación. 
\item Definición de modelo de datos con FIWARE.
\end{itemize}
\divider

\cvevent{Tutor Trabajo Fin de Titulación}{UPM}{Enero 2019 -- Actualidad}{Madrid}
\begin{itemize}
...
\cvevent{Integración Digital de la ETSIT}{Beca Fundación Ángel Barbero Martín de Vidales}{Marzo 2018 -- Actualidad}{Madrid}
\begin{itemize}
